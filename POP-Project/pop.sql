...
CREATE TABLE IF NOT EXISTS `pop` (
  ...
  `medische_informatie` varchar(255) DEFAULT NULL,	
  ...
  `vrienden2` int(1)  DEFAULT NULL COMMENT '1 = Ja / NULL = Nee , maak je makkelijk vrienden?',
  `presenteren` int(1)  DEFAULT NULL COMMENT '1 = Ja / NULL = Nee , durf je jezelf te presenteren?',
  `opkomen` int(1)  DEFAULT NULL COMMENT '1 = Ja / NULL = Nee , Durf je voor jezelf over te komen?',
  `werkhouding_les` varchar(255) DEFAULT NULL,
  `werkhouding_thuis` varchar(255) DEFAULT NULL,
  `voorbereiden_toetsen` varchar(255) DEFAULT NULL,
  `werktempo_les` int(2) unsigned DEFAULT NULL COMMENT 'Cijfer 1 tot 10',
  `plannen` int(2) unsigned DEFAULT NULL COMMENT 'Cijfer 1 tot 10',
  `spullen_op_orde` int(2) unsigned DEFAULT NULL COMMENT 'Cijfer 1 tot 10',
  `vragen_stellen_docent` int(2) unsigned DEFAULT NULL COMMENT 'Cijfer 1 tot 10',
  `maakwerk` int(2) unsigned DEFAULT NULL COMMENT 'Cijfer 1 tot 10',
  `leerwerk` int(2) unsigned DEFAULT NULL COMMENT 'Cijfer 1 tot 10',
  `initiatief` int(2) unsigned DEFAULT NULL COMMENT 'Cijfer 1 tot 10',
  `samenwerken` int(2) unsigned DEFAULT NULL COMMENT 'Cijfer 1 tot 10',
  `communicatie_met_docent` int(2) unsigned DEFAULT NULL COMMENT 'Cijfer 1 tot 10',
  `communicatie_met_mentor` int(2) unsigned DEFAULT NULL COMMENT 'Cijfer 1 tot 10',
  `communicatie met medeleerlingen` int(2) unsigned DEFAULT NULL COMMENT 'Cijfer 1 tot 10',
  `concentratie_in_les` int(2) unsigned DEFAULT NULL COMMENT 'Cijfer 1 tot 10',
  `concentratie_thuis` int(2) unsigned DEFAULT NULL COMMENT 'Cijfer 1 tot 10',
  `presenteren` int(2) unsigned DEFAULT NULL COMMENT 'Cijfer 1 tot 10',
  `extreme_inzet` varchar(255) DEFAULT NULL COMMENT 'Plaats vakken',
  `geweldige_inzet` varchar(255) DEFAULT NULL COMMENT 'Plaats vakken',
  `prima_inzet` varchar(255) DEFAULT NULL COMMENT 'Plaats vakken',
  `goede_inzet` varchar(255) DEFAULT NULL COMMENT 'Plaats vakken',
  `beetje_inzet` varchar(255) DEFAULT NULL COMMENT 'Plaats vakken',
  `klein_beetje_inzet` varchar(255) DEFAULT NULL COMMENT 'Plaats vakken',
